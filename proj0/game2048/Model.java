...
public class Model extends Observable {
    ...
    public static boolean emptySpaceExists(Board b) {
        ...
        // Iterate over all tiles on the board to check if there is an empty tile.
        for (int col_runner = 0; col_runner < b.size(); col_runner++) {
            for (int row_runner = 0; row_runner < b.size(); row_runner++) {
    ...
    public static boolean maxTileExists(Board b) {
        // TODO: Fill in this function.
        // Iterate over all tiles on the board to check if there is a tile with value as the max value.
        for (int col_runner = 0; col_runner < b.size(); col_runner++) {
            for (int row_runner = 0; row_runner < b.size(); row_runner++) {
                if (b.tile(col_runner, row_runner) != null &&
                        b.tile(col_runner, row_runner).value() == MAX_PIECE) {
                    return true;
                }
            }
        }
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        // TODO: Fill in this function.
        boolean has_twin_tiles = false;

        // Iterate over all the tiles to check if it has a neighbor that has the same value as it.
        for (int col_runner = 0; col_runner < b.size(); col_runner++) {
            for (int row_runner = 0; row_runner < b.size(); row_runner++) {
                // First check that the tile is not empty.
                if (b.tile(col_runner, row_runner) != null) {
                    ...
                    // Step 3: Check the west direction.
                            ...
                            b.tile(col_runner - 1, row_runner).value() == value) { has_twin_tiles = true; }
                    // Step 4: Check the east direction.
                    else if (col_runner < b.size() - 1 &&
                            b.tile(col_runner + 1, row_runner) != null &&
                            b.tile(col_runner + 1, row_runner).value() == value) { has_twin_tiles = true; }
                }
            }
